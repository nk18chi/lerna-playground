...
export default function Home() {
  return (
    <main className='flex min-h-screen flex-col items-center justify-between p-24'>
      <Button label={"Click Now1"} />
      <Button label={"Click Now2"} />
      <Button label={"Click Now3"} />
      <Button label={"Click Now4"} />
      <Button label={"Click Now5"} />
      <Button label={"Click Now6"} />
      <Button label={"Click Now7"} />
      <Button label={"Click Now8"} />
      <Button label={"Click Now9"} />
      <Button label={"Click Now10"} />
